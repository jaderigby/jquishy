...
else if(args[0].constructor===Object){let attributeString='';for(let key in args[0]){let keyString=key.replace(/([a-z])([A-Z])/g,'$1-$2').toLowerCase();let newAttribute=`${keyString} : ${args[0][key]};`;attributeString+=newAttribute}
